...
@section('content')
<h1 class="title">Tambah Surat Masuk</h1>

<form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" name="pengirim" id="pengirim" placeholder="Pengirim" required>
    </div>
